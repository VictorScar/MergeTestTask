...
namespace MergeGame._Scenarios
{
    public class GameLevelScenario : GameplayScenarioBase
    {
        ...
        {
            _config = config;
            _fieldController = GameServiceLocator.I.GameplayControllersProvider.CraftFieldController;
        ...
        protected override void RunInternal(CancellationToken gameCancellationToken)
        {
